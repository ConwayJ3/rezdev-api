...
<body style="margin:0;padding:0;background:#f4f6f8;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:32px 20px;">
    <div style="background:#0C2340;border-radius:14px 14px 0 0;padding:30px 32px;text-align:center;">
      ...
      <div style="color:rgba(255,255,255,.6);font-size:12px;margin-top:8px;">Client Portal</div>
    </div>
