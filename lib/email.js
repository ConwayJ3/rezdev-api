...
<body style="margin:0;padding:0;background:#f4f6f8;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:32px 20px;">
    <div style="background:#0C2340;border-radius:14px 14px 0 0;padding:28px 32px;text-align:center;">
      <img src="https://nuljmkryxqdowvlcagmq.supabase.co/storage/v1/object/public/logos/rezdev_rd_icon.png" alt="RezDev" width="52" height="52" style="width:52px;height:52px;object-fit:contain;border-radius:10px;background:#fff;padding:4px;"/>
      <div style="color:#fff;font-size:20px;font-weight:800;letter-spacing:-.5px;margin-top:10px;">RezDev</div>
      <div style="color:rgba(255,255,255,.6);font-size:12px;margin-top:2px;">Client Portal</div>
    </div>
